...
/** @test {exhaustScan} */
describe('Observable.prototype.exhaustScan', () => {
  it('should exhaustScan things', () => {
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) => Observable.of(acc.concat(x)), []);
  ...
  it('should exhaustScan values and be able to asynchronously project them', () => {
    const e1 = hot('--a--^--b--c--d--e--f--g--|');
    const e1subs =      '^                    !';
    const expected =    '-----u--v--w--x--y--z|';
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) =>
  ...
  it('should propagate errors from the projected Observable', () => {
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) => Observable.throw('bad!'), []);
  ...
  it('should handle an empty projected Observable', () => {
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) => Observable.empty(), []);
  ...
  it('should handle a never projected Observable', () => {
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) => Observable.never(), []);
  ...
  it('should exhaustScan unsubscription', () => {
    const e1 = hot('--a--^--b--c--d--e--f--|');
  ...
  it('should emit accumulator if inner completes without value', () => {
    ...
    const source = (<any>e1).exhaustScan((acc: any, x: string) => Observable.empty(), ['1']);
